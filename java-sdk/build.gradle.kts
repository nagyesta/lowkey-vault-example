...
dependencyManagement {
    dependencies {
        ...
        dependency("com.azure:azure-security-keyvault-secrets:4.11.0")
        dependency("com.azure:azure-security-keyvault-keys:4.11.0")
        dependency("com.azure:azure-security-keyvault-certificates:4.9.0")
