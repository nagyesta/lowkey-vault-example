...
dependencyManagement {
    dependencies {
        dependency("org.springframework.boot:spring-boot-starter-web:4.0.0")
        dependency("org.springframework.boot:spring-boot-configuration-processor:4.0.0")
        dependency("org.springframework.boot:spring-boot-starter-test:4.0.0")
