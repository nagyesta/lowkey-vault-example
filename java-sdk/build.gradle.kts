...
dependencyManagement {
    dependencies {
        dependency("org.springframework.boot:spring-boot-starter-web:3.4.5")
        dependency("org.springframework.boot:spring-boot-configuration-processor:3.4.5")
        dependency("org.springframework.boot:spring-boot-starter-test:3.4.5")
        ...
        dependency("com.azure:azure-identity:1.16.0")
        dependency("com.github.nagyesta.lowkey-vault:lowkey-vault-client:3.1.0")
        dependency("com.github.nagyesta.lowkey-vault:lowkey-vault-testcontainers:3.1.0")
    }
}
