...
dependencyManagement {
    dependencies {
        dependency("org.springframework.boot:spring-boot-starter-web:4.0.3")
        dependency("org.springframework.boot:spring-boot-configuration-processor:4.0.3")
        dependency("org.springframework.boot:spring-boot-starter-test:4.0.3")
        ...
        dependency("com.github.nagyesta.lowkey-vault:lowkey-vault-client:7.1.13")
