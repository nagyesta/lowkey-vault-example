...
dependencyManagement {
    dependencies {
        dependency("org.springframework.boot:spring-boot-starter-web:3.5.0")
        dependency("org.springframework.boot:spring-boot-configuration-processor:3.5.0")
        ...
        dependency("com.github.nagyesta.lowkey-vault:lowkey-vault-client:3.1.37")
        dependency("com.github.nagyesta.lowkey-vault:lowkey-vault-testcontainers:3.1.37")
    }
}
